      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
        ...
        <div className="text-center lg:text-left">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
            <Link href="/waiting-list?action=true">
              <Button 
                className="bg-gray-900 text-white px-8 py-4 rounded-xl font-bold hover:bg-gray-800 hover:shadow-lg transition-all duration-300 text-lg"
              >
            ...
            <Link href="/waiting-list?action=true">
              <Button 
                variant="outline" 
                className="bg-white hover:bg-gray-50 px-8 py-4 rounded-xl font-medium text-lg border-gray-300 text-gray-700 hover:border-gray-400 hover:text-gray-800"
              >
        ...
        <div className="relative">
          <div className="bg-gradient-to-br from-gray-50 to-white rounded-2xl p-8 shadow-xl border border-gray-100">
            ...
            {/* Early Access CTA */}
            <div className="bg-gradient-to-r from-[#8B4513]/10 to-[#8B4513]/5 rounded-xl p-4 border border-[#8B4513]/20">
              <div className="text-center">
                ...
                <Link href="/waiting-list?action=true">
                  <Button 
                    className="bg-gray-900 text-white px-4 py-2 rounded-xl font-medium text-sm hover:bg-gray-800"
                  >
                    Join Waitlist
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 sm:gap-8 md:gap-12 lg:gap-16 xl:gap-20 items-center">
          ...
          <div className="lg:col-span-2 space-y-6 sm:space-y-8 md:space-y-10 lg:space-y-12 text-center lg:text-left">
            ...
            <div>
              ...
              <Link href="/waiting-list?action=true">
                <Button 
                  className="bg-gray-900 text-white px-4 sm:px-6 md:px-8 py-3 sm:py-4 rounded-xl font-bold hover:bg-gray-800 hover:shadow-lg transition-all duration-300 text-sm sm:text-base md:text-lg w-full sm:w-auto"
                >
    ...
    <div className="py-8 sm:py-12 lg:py-16 bg-gray-100">
      <div className="w-full px-4 sm:px-6 lg:px-10">
            ...
            blogPosts.map((post) => (
              ...
              <div className="relative h-48 overflow-hidden">
                ...
                <div className="absolute top-4 left-4 bg-white rounded-full px-3 py-1">
                  <span className="text-xs font-bold text-gray-700">{post.category}</span>
                </div>
              </div>
              <CardContent className="p-6 flex-1 flex flex-col">
                <h3 className="text-xl font-bold text-gray-900 mb-3 group-hover:text-gray-700 transition-colors min-h-[4.5rem]">
                  {post.title}
                </h3>
        ...
        <div className="text-center mt-12">
            ...
            <Button 
              variant="outline" 
              className="border-gray-300 text-gray-700 hover:bg-gray-100 hover:border-gray-400 hover:text-gray-800 px-8 py-3 rounded-xl font-medium"
            >
              View All Articles
            </Button>
          </Link>
